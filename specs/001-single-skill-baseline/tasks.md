...
- [ ] T057 T025/T051 live-service round-trip (Codex + ChatGPT Project + GitHub PR) remains unexecuted — external-environment dependency, unchanged by this round. See T051 and `T025-validation-runbook.md`.
