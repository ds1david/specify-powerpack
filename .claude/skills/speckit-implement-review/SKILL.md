...
description: Specify PowerPack implementation-quality convergence/review gate after
  an explicit speckit-implement.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: preset:powerpack-core
user-invocable: true
disable-model-invocation: false
---

# Speckit Implement Review Skill
